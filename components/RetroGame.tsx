  ...
  if (!activeUser) {
    return (
      <div className="fixed inset-0 z-[100] bg-slate-950 flex items-center justify-center p-6 animate-fade-in">
        <div className="bg-slate-900 p-8 rounded-[32px] border border-slate-700 shadow-2xl max-w-sm text-center">
          <div className="bg-primary/20 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
            <Gamepad2 size={40} className="text-primary" />
          </div>
          <h2 className="text-2xl font-bold text-white mb-2">Coaster Dash</h2>
          <p className="text-slate-400 text-sm mb-8">Sign in to save your high scores and compete on the leaderboard!</p>
          <div className="space-y-3">
            ...
            <button 
              ...
              className="w-full bg-slate-800 hover:bg-slate-700 text-white py-4 rounded-2xl font-bold border border-slate-700 transition-all active:scale-95"
            >
              Back to Hub
            </button>
          </div>
